...
define(function () { 'use strict';
	...
	$(function() {
	 ...
	 function prepareRegistrationPayloadAndCallApi() {
	  ...
	  $('#registerUser').off("click").on("click", function(event) {
	    ...
	    if($(form).valid())  {
	      let inputs = {
	        name: $(form).find("#exampleInputUsername").val(),
	  ...
	  debugger;
	    ...
	    switch(whichPopup) {
	      ...
	      case "creatorsignup": 
	        ...
	        $("#creatorSignupModal .creator-signup-step-2").hide();
	          break;
	...
	function registerUser(formElem) {
	  ...
	  $.ajax({
	    url: "https://abit-backend-production.up.railway.app/api/auth/register",
	    type: 'POST',
	...
	function loginUser(formElem) {
	  $.ajax({
	    url: "https://abit-backend-production.up.railway.app/api/auth/login",
	    type: 'POST',
	    data: JSON.stringify(this),
	    contentType: "application/json; charset=utf-8",
	    success: function (data) {
